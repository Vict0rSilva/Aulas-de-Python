...
## 🚀 Objetivo
Desenvolver habilidades sólidas em programação, praticando constantemente e organizando todo o aprendizado de forma clara.
...
- **EX** → Exercícios realizados durante as aulas  
- **DSF** → Desafios/atividades propostas nas aulas  
